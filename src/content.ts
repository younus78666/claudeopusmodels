...
export const posts: BlogPost[] = [
  ...
  },
  {
    ...
    seoTitle: "Claude Opus 4 Review: Deep Reasoning & Reliability",
    excerpt:
...
For simpler tasks where latency matters, Sonnet or Haiku remain better fits. The Claude model family is designed to offer the right tool for each job.`,
  ...
  },
  {
    ...
    seoTitle: "Claude Constitutional AI: Trust Through Transparency",
    excerpt:
...
This is a feature, not a limitation.`,
  ...
  },
  {
    ...
    seoTitle: "Sonnet vs Opus vs Haiku: Pick the Right Claude Model",
    excerpt:
...
This tiered approach often outperforms using a single model for everything — you get better results *and* lower costs.`,
  ...
  },
  {
    ...
    seoTitle: "Extended Thinking: How Claude Reasons in 2026",
    excerpt:
      "Inside the mechanism that lets Claude allocate more compute to harder problems, and how to prompt for it effectively in production workflows.",
...
Extended thinking is particularly valuable for content that needs to demonstrate expertise. By reasoning through problems rather than pattern-matching to answers, Claude produces responses that reflect genuine analytical depth — the kind of reasoning that distinguishes expert content from surface-level summaries.`,
  ...
  },
  {
    ...
    seoTitle: "E-E-A-T Framework for AI Content with Claude",
    excerpt:
      "Google's quality guidelines meet AI-generated content. A practical approach to creating Claude-assisted content that ranks and resonates with readers.",
